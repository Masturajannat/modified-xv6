...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3eb:	39 d9                	cmp    %ebx,%ecx
    buf[i++] = digits[x % base];
 3ed:	0f b6 92 30 08 00 00 	movzbl 0x830(%edx),%edx
  }while((x /= base) != 0);
 ...
 469:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4d3:	ff 24 85 d8 07 00 00 	jmp    *0x7d8(,%eax,4)
 ...
 608:	bf d1 07 00 00       	mov    $0x7d1,%edi
 ...
 641:	a1 e4 0a 00 00       	mov    0xae4,%eax
{
 ...
 689:	5b                   	pop    %ebx
  freep = p;
 68a:	89 15 e4 0a 00 00    	mov    %edx,0xae4
}
 690:	5e                   	pop    %esi
 691:	5f                   	pop    %edi
 692:	5d                   	pop    %ebp
 ...
 6c7:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6ca:	89 15 e4 0a 00 00    	mov    %edx,0xae4
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6e9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6ec:	8b 15 e4 0a 00 00    	mov    0xae4,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 72b:	39 05 e4 0a 00 00    	cmp    %eax,0xae4
 ...
 74e:	e8 ed fe ff ff       	call   640 <free>
  return freep;
 753:	8b 15 e4 0a 00 00    	mov    0xae4,%edx
 ...
 77c:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 77f:	89 15 e4 0a 00 00    	mov    %edx,0xae4
}
 ...
 797:	0a 00 00 
    base.s.size = 0;
 79a:	b8 e8 0a 00 00       	mov    $0xae8,%eax
    base.s.ptr = freep = prevp = &base;
 79f:	c7 05 e8 0a 00 00 e8 	movl   $0xae8,0xae8
 7a6:	0a 00 00 
    base.s.size = 0;
