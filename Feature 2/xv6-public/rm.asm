...
main(int argc, char *argv[])
{
  ...
  33:	ff 33                	push   (%ebx)
  35:	e8 09 03 00 00       	call   343 <unlink>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3eb:	39 d9                	cmp    %ebx,%ecx
    buf[i++] = digits[x % base];
 3ed:	0f b6 92 54 08 00 00 	movzbl 0x854(%edx),%edx
  }while((x /= base) != 0);
 ...
 641:	a1 0c 0b 00 00       	mov    0xb0c,%eax
{
 ...
 689:	5b                   	pop    %ebx
  freep = p;
 68a:	89 15 0c 0b 00 00    	mov    %edx,0xb0c
}
 690:	5e                   	pop    %esi
 691:	5f                   	pop    %edi
 692:	5d                   	pop    %ebp
 ...
 6c7:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6ca:	89 15 0c 0b 00 00    	mov    %edx,0xb0c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6e9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6ec:	8b 15 0c 0b 00 00    	mov    0xb0c,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 72b:	39 05 0c 0b 00 00    	cmp    %eax,0xb0c
 ...
 74e:	e8 ed fe ff ff       	call   640 <free>
  return freep;
 753:	8b 15 0c 0b 00 00    	mov    0xb0c,%edx
 ...
 797:	0b 00 00 
    base.s.size = 0;
 79a:	b8 10 0b 00 00       	mov    $0xb10,%eax
    base.s.ptr = freep = prevp = &base;
 79f:	c7 05 10 0b 00 00 10 	movl   $0xb10,0xb10
 7a6:	0b 00 00 
    base.s.size = 0;
 7a9:	c7 05 14 0b 00 00 00 	movl   $0x0,0xb14
 7b0:	00 00 00 
    if(p->s.size >= nunits){
