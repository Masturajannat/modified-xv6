...
main(int argc, char **argv)
{
  ...
  52:	50                   	push   %eax
  53:	50                   	push   %eax
  54:	68 c8 07 00 00       	push   $0x7c8
  59:	6a 02                	push   $0x2
  5b:	e8 00 04 00 00       	call   460 <printf>
    exit();
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3eb:	39 d9                	cmp    %ebx,%ecx
    buf[i++] = digits[x % base];
 3ed:	0f b6 92 3c 08 00 00 	movzbl 0x83c(%edx),%edx
  }while((x /= base) != 0);
 ...
 469:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4d3:	ff 24 85 e4 07 00 00 	jmp    *0x7e4(,%eax,4)
 ...
 608:	bf dc 07 00 00       	mov    $0x7dc,%edi
...
free(void *ap)
{
 ...
 641:	a1 f4 0a 00 00       	mov    0xaf4,%eax
{
 ...
 689:	5b                   	pop    %ebx
  freep = p;
 68a:	89 15 f4 0a 00 00    	mov    %edx,0xaf4
}
 690:	5e                   	pop    %esi
 691:	5f                   	pop    %edi
 692:	5d                   	pop    %ebp
 ...
 6c7:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6ca:	89 15 f4 0a 00 00    	mov    %edx,0xaf4
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6e9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6ec:	8b 15 f4 0a 00 00    	mov    0xaf4,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 72b:	39 05 f4 0a 00 00    	cmp    %eax,0xaf4
 ...
 74e:	e8 ed fe ff ff       	call   640 <free>
  return freep;
 753:	8b 15 f4 0a 00 00    	mov    0xaf4,%edx
 ...
 77c:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 77f:	89 15 f4 0a 00 00    	mov    %edx,0xaf4
}
 ...
 78f:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 790:	c7 05 f4 0a 00 00 f8 	movl   $0xaf8,0xaf4
 797:	0a 00 00 
    base.s.size = 0;
 79a:	b8 f8 0a 00 00       	mov    $0xaf8,%eax
    base.s.ptr = freep = prevp = &base;
 79f:	c7 05 f8 0a 00 00 f8 	movl   $0xaf8,0xaf8
 7a6:	0a 00 00 
    base.s.size = 0;
 7a9:	c7 05 fc 0a 00 00 00 	movl   $0x0,0xafc
 7b0:	00 00 00 
    if(p->s.size >= nunits){
